const Reviews = () => {
  return (
    <div className='w-full rounded-lg flex flex-col pb-72'>
      <div className='text-white flex flex-row bg-yellow-500 p-2 rounded-t-lg space-x-2 items-center'>
        <svg
          className='w-6 h-6'
          fill='none'
          stroke='currentColor'
        ...
        <div className='flex flex-col px-4 py-6 w-6/12 space-y-5'>
          ...
          <form action=''>
            ...
            <input
              type='submit'
              value='Submit'
              className='bg-yellow-500 text-white p-2 w-full transform -translate-y-10 z-50 rounded-b-lg cursor-pointer rounded-t-none'
            />
          </form>
        </div>
